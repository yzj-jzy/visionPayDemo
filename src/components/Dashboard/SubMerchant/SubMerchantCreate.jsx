...
import { createSubMerchant } from '../../../api/SubMerchant';
import ContentStyle from '../ContentStyle';
import { useAuth } from '../../../contexts/ContentContext';

const SubMerchantCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      try {
        ...
        const res = await createSubMerchant(formattedData);
        if(res.success){
          loadUserDetail();
  ...
  return (
    <ContentStyle>
      <div className="bg-gradient-to-b from-blue-50 to-blue-100 rounded-xl  p-8 shadow-lg phone:overflow-x-auto tabletSmall:overflow-x-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">Create New Merchant</h1>
...
export default SubMerchantCreate;
