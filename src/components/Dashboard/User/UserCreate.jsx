...
const UserCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await createUser(newUser.userName, newUser.role, newUser.subMerchants);
    ...
    return (
        <ContentStyle>
            <div className="h-96 phone:overflow-x-auto tabletSmall:overflow-x-auto bg-white rounded-3xl pb-44 p-6 box-content pt-12">    
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="flex flex-wrap gap-6">
                            ...
                            <div className="w-full ml-1 lg:w-1/2 flex-1 min-w-[250px]">
                                ...
                                {/* Create User Button */}
                                <div className="w-full mt-8 phone:hidden">
                                    <button
                                        type="submit"
                            ...
                            <div className="hidden phone:block w-full mt-8">
                                    <button
                                        type="submit"
                                        className="w-full px-6 py-3 text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg shadow-md text-base font-semibold transition duration-150 ease-in-out"
                                    >
